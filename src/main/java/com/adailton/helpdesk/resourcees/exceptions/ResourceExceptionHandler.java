package com.adailton.helpdesk.resourcees.exceptions;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> validationErros(MethodArgumentNotValidException ex, HttpServletRequest request){
		...
		ValidationError errors = new ValidationError(System.currentTimeMillis(), HttpStatus.BAD_REQUEST.value(), "Validation error","Erro na validação dos camos", request.getRequestURI());
